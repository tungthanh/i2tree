...
public class GreengarUserUtil {
	final static GreengarUserUtil theInstance = new GreengarUserUtil();
	static OAuth2Tokens auth2Tokens;
	
	public static GreengarUserUtil theInstance(){
		return theInstance;
	}
	
	protected GreengarUserUtil() {
	...
	public boolean like(String imgSrc) {
		try {
			if(auth2Tokens == null){
				...
				auth2Tokens = GreengarUserUtil.login(email, password);
