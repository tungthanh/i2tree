...
<!--[if (gte IE 9)|!(IE)]><!--><html class="no-js"><!--<![endif]-->
    ...
    <body lang="en">
        ...
        <p>
            ...
            <input type="text" id="username" name="username" placeholder="demo" value="tester" />
        </p>

        <p>
            <label for="password">Your password</label><br>
            <input type="password" id="password" name="password" placeholder="demotest" value="123456" />
        </p>
