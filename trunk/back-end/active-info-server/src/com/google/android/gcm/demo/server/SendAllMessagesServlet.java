	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (devices.isEmpty()) {
			...
			if (devices.size() == 1) {
				...
				Message message = new Message.Builder().addData("url", "http://www.thinkbigmagazine.com/images/article_pics/problem-free.jpg").build();
				System.out.println(message.getData().get("url"));
